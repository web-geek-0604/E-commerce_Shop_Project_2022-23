...
<div class="offers-wrapper">
    <div class="offers-container" style="margin:10px auto;">
        <h1 class="section-heading">Izaberite Vaš model RTX 4090 kartice</h1>
        <div class="offers-flex-div">
            <?php $sql1 = "SELECT * FROM proizvodi WHERE naziv LIKE '%4090%'";
        $res1=$db->query($sql1);
